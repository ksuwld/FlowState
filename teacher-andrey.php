...
$static_reviews = [
    ['name' => 'Гуманникова Ирина', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Андрей восстановил меня после кесарева. Очень мягко и без спешки вернули тонус животу'],
    ['name' => 'Погрешкина Ольга', 'avatar' => 'ava4.png', 'rating' => 4.0, 'text' => 'Пришел после травмы мениска. Андрей работает в связке с моим реабилитологом. Прогресс налицо!'],
    ['name' => 'Каторожкина Марина', 'avatar' => 'ava6.png', 'rating' => 5.0, 'text' => 'Был перелом ноги и почитав отзывы решила записаться к данному тренеру. Ходила около двух недель, и ситуация кардинально улучшилась. В итоге полностью восстановилась. Могу поставить только 5 звезд.'],
    ['name' => 'Давыдина Светлана', 'avatar' => 'ava7.png', 'rating' => 3.0, 'text' => 'Отличный тренер, каждый человек сможет сделать те упражнения, которые дает Андрей. Очень эффективный подход!'],
    ['name' => 'Васильев Владислав', 'avatar' => 'ava8.png', 'rating' => 4.0, 'text' => 'Очень тактичный и эмпатичный тренер. С ним не страшно начинать заниматься после долгой болезни.']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Смирнов Андрей' LIMIT 1");
    $stmt_id->execute();
...
<head>
    ...
    <title>Смирнов Андрей — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/андрей.png" alt="Андрей Фото 1" class="tp-hero-img">
                <img src="img/андрей1.png" alt="Андрей Фото 2" class="tp-hero-img"> 
                <img src="img/андрей2.png" alt="Андрей Фото 3" class="tp-hero-img">
                <img src="img/андрей3.png" alt="Андрей Фото 4" class="tp-hero-img">
                <img src="img/андрей4.png" alt="Андрей Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Смирнов Андрей</h1>
        <p class="tp-subtitle">Преподаватель по "Pilates Recovery" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Здравствуйте, я Андрей. Моя зона ответственности — восстановление. Я работаю с теми, кто возвращается к фитнесу после травм, родов или длительных перерывов.</p>
            <p>Мой подход максимально бережный. Я не тороплю события. Мы работаем с микродвижениями, восстанавливая утраченные нейронные связи между мозгом и травмированной мышцей.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Сбор анамнеза:</strong> Детально разбираем вашу историю травмы, рекомендации врачей и текущие ограничения.</li>
                <li><strong>Изолированная реабилитация:</strong> Очень медленные, контролируемые упражнения на восстановление функции поврежденного сустава.</li>
                <li><strong>Дыхательная терапия:</strong> Использование диафрагмального дыхания для снятия спазмов и ускорения процессов регенерации тканей.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Восстановление — это не гонка, это процесс любви к себе. Ваше тело способно исцелить себя само, если создать ему правильные условия. Шаг за шагом, бережно и уверенно, мы вернем вам радость движения без боли.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
       <button class="tp-btn-book" id="book-btn" data-teacher="Смирнов Андрей" data-class="Pilates Recovery" data-time="20:00 - 21:30">Записаться на тренировку</button>
