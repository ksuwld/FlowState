...
$static_reviews = [
    ['name' => 'Даванков Максим', 'avatar' => 'ava9.png', 'rating' => 5.0, 'text' => 'Анна открыла для меня мир МФР. Ушли головные боли напряжения и отеки по утрам.'],
    ['name' => 'Лукревич Маргарита', 'avatar' => 'ava7.png', 'rating' => 5.0, 'text' => 'До этого ролл валялся дома без дела, было больно. Анна научила правильной технике — теперь это кайф!'],
    ['name' => 'Кутузова Алина', 'avatar' => 'ava10.png', 'rating' => 5.0, 'text' => 'Лучшее восстановление после тяжелой рабочей недели. Выходишь легкая, как перышко.'],
    ['name' => 'Копорина Ксения', 'avatar' => 'ava11.png', 'rating' => 5.0, 'text' => 'Прекрасный тренер, прекрасные программы!']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Кудрявцева Анна' LIMIT 1");
    $stmt_id->execute();
    $t_row = $stmt_id->fetch(PDO::FETCH_ASSOC);
    $teacher_id = $t_row ? $t_row['id'] : 11; 
...
<head>
    ...
    <title>Кудрявцева Анна — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/анна.png" alt="Анна Фото 1" class="tp-hero-img">
                <img src="img/анна1.png" alt="Анна Фото 2" class="tp-hero-img"> 
                <img src="img/анна2.png" alt="Анна Фото 3" class="tp-hero-img">
                <img src="img/анна3.png" alt="Анна Фото 4" class="tp-hero-img">
                <img src="img/анна4.png" alt="Анна Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        <div class="tp-badge">Стаж: 3 года</div>
        <h1 class="tp-name">Кудрявцева Анна</h1>
        <p class="tp-subtitle">Преподаватель по "MFR & Stretch" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Привет! Я Анна, эксперт по миофасциальному релизу (МФР) и растяжке. Я называю свои занятия "генеральной уборкой" для тела.</p>
            <p>Спазмы, склейки фасций, триггерные точки — всё это копится в нас из-за стресса и плохой осанки. С помощью специальных массажных роллов и мячей мы будем раскатывать это напряжение, возвращая тканям эластичность и влагу.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Глубокая прокатка (МФР):</strong> Ищем и мягко воздействуем на болевые триггеры с помощью роллов разной жесткости.</li>
                <li><strong>Глобальное вытяжение:</strong> После того как мышца расслабилась на ролле, мы легко и без боли вытягиваем её на коврике.</li>
                <li><strong>Лимфодренажный эффект:</strong> Специфические техники дыхания и прокатки запускают движение лимфы, снимая отеки.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Тело помнит всё. Каждую невысказанную эмоцию и каждый час за рулем. Моя задача — помочь вам "распаковать" это напряжение. МФР — это легальный способ сделать себе качественный массаж и заново родиться.»</p>
        </div>
    </section>
                    ...
                    <div class="tp-review-item">
                        ...
                        <div class="tp-review-content">
                            <div class="tp-review-header">
                                <span class="tp-reviewer-name"><strong><?= htmlspecialchars($rev['name'] ?? 'Администратор') ?></strong></span>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Кудрявцева Анна" data-class="MFR & Stretch" data-time="13:30 - 15:00">Записаться на тренировку</button>
