...
$static_reviews = [
    ['name' => 'Гуманникова Ирина', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Пилатес с кольцом — это огонь! Михаил дает такие вариации, что мышцы горят в хорошем смысле.'],
    ['name' => 'Тиньков Олег', 'avatar' => 'ava2.png', 'rating' => 5.0, 'text' => 'Тренировки пролетают незаметно из-за постоянной смены инвентаря. Очень интересно и эффективно.'],
    ['name' => 'Разнобравин Давид', 'avatar' => 'ava3.png', 'rating' => 5.0, 'text' => 'Михаил помог мне "почувствовать" спину с помощью ролла. Гениальный тренер']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Мухин Михаил' LIMIT 1");
    $stmt_id->execute();
...
<head>
    ...
    <title>Мухин Михаил — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/михаил1.png" alt="Михаил Фото 1" class="tp-hero-img">
                <img src="img/михаил2.png" alt="Михаил Фото 2" class="tp-hero-img"> 
                <img src="img/михаил3.png" alt="Михаил Фото 3" class="tp-hero-img">
                <img src="img/михаил4.png" alt="Михаил Фото 4" class="tp-hero-img">
                <img src="img/михаил5.png" alt="Михаил Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Мухин Михаил</h1>
        <p class="tp-subtitle">Преподаватель по "Pilates Props" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Меня зовут Михаил, and я обожаю делать пилатес разнообразным! Моя специализация — Pilates Props (пилатес с малым оборудованием).</p>
            <p>Изотонические кольца, фитболы, эспандеры и роллы — это не просто игрушки. Это инструменты, которые дают телу потрясающую проприоцепцию (обратную связь). Они могут как усложнить базовое упражнение, так и помочь выполнить его технически безупречно.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Выбор инвентаря:</strong> Подбираем оборудование под вашу конкретную цель (резина для силы, мяч для баланса, кольцо для выравнивания).</li>
                <li><strong>Работа с сопротивлением:</strong> Учимся преодолевать мягкое сопротивление инвентаря, включая в работу всю мышечную цепь.</li>
                <li><strong>Нейромышечный фокус:</strong> Используем оборудование для того, чтобы мозг лучше "увидел" слепые зоны тела.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Ваше тело быстро привыкает к рутине. Малое оборудование бросает вызов вашей координации и балансу, заставляя нейронные связи работать на максимум. Со мной вам никогда не будет скучно!»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Мухин Михаил" data-class="Pilates Props" data-time="13:30 - 15:00">Записаться на тренировку</button>
