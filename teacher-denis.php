...
$static_reviews = [
    ['name' => 'Даванков Максим', 'avatar' => 'ava9.png', 'rating' => 5.0, 'text' => 'Отличный тренер, Денис очень круто объясняет биомеханику движения. Тренировки интенсивные, но прогресс просто потрясающий. Я очень доволен!'],
    ['name' => 'Воркович Полина', 'avatar' => 'ava5.png', 'rating' => 4.0, 'text' => 'До Дениса была уверена, что шпагат — это просто не для моей генетики. Но его подход с акцентом на активную гибкость сотворил чудо. Села на продольный через 3 месяца регулярных занятий, очень благодарна тренеру! Но хочу снизить -1 балл за опоздания.'],
    ['name' => 'Суворов Евгений', 'avatar' => 'ava8.png', 'rating' => 5.0, 'text' => 'Был на нескольких занятиях. Техника дается хорошо, подход Дениса позволяет даже новичкам вроде меня быстро втянуться и начать чувствовать свое тело. Рекомендую!'],
    ['name' => 'Лукревич Маргарита', 'avatar' => 'ava7.png', 'rating' => 2.0, 'text' => 'Мне абсолютно не понравилась техника и то, как преподает денис! 2 балла!'],
    ['name' => 'Кутузова Алина', 'avatar' => 'ava10.png', 'rating' => 2.0, 'text' => 'Согласна с Маргаритой.'],
    ['name' => 'Копорина Ксения', 'avatar' => 'ava11.png', 'rating' => 5.0, 'text' => 'Тренировки мощные, результат есть — прогресс в поперечном шпагате налицо, тянемся с кубиками и ремнями. Денис всегда успевает уделить внимание каждому ученику.'],
    ['name' => 'Понамарюк Виктор', 'avatar' => 'ava12.png', 'rating' => 4.0, 'text' => 'Очень комфортная атмосфера на занятиях. Денис невероятно тактичный и внимательный. Всегда контролирует, чтобы не было острой боли, учит правильно дышать и расслаблять нервную систему. Выходишь с тренировки с абсолютной легкостью.'],
    ['name' => 'Тушковин Сергей', 'avatar' => 'ava13.png', 'rating' => 5.0, 'text' => 'Профессиональный подход, тянемся плавно, через сопротивление и ПИР (постизометрическую релаксацию). Денис вернул мне доверие к стретчингу после травмы. Огромное спасибо тренеру!']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Авдеев Денис' LIMIT 1");
    $stmt_id->execute();
...
<head>
    ...
    <title>Авдеев Денис — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/денис.png" alt="Денис Фото 1" class="tp-hero-img">
                <img src="img/денис1.png" alt="Денис Фото 2" class="tp-hero-img"> 
                <img src="img/денис2.png" alt="Денис Фото 3" class="tp-hero-img">
                <img src="img/денис3.png" alt="Денис Фото 4" class="tp-hero-img">
                <img src="img/денис4.png" alt="Денис Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Авдеев Денис</h1>
        <p class="tp-subtitle">Преподаватель по "Split stretching" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Привет! Я Денис, специалист по безопасной продольной и поперечной растяжке. Многие боятся шпагатов, ассоциируя их со спортивной гимнастикой и слезами.</p>
            <p>Я разрушаю этот стереотип. Мой подход основан на биомеханике тазобедренного сустава и нейрофизиологии. Мы договоримся с вашей нервной системой, чтобы она сама "разрешила" ногам разъехаться в заветный шпагат.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Активный пре-стретч:</strong> Динамические движения для разогрева суставной жидкости и улучшения скольжения фасций.</li>
                <li><strong>Укрепление антагонистов:</strong> Мы закачиваем те мышцы, которые будут поддерживать ваши суставы в крайних амплитудах.</li>
                <li><strong>Мягкое погружение:</strong> Используем кубики и скользящие диски для плавного опускания в шпагат под моим чутким контролем.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Шпагат — это побочный эффект здоровых и мобильных суставов. Я не посажу вас на шпагат за неделю, но я обещаю, что наш путь будет безопасным, приятным, а результат останется с вами надолго.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Авдеев Денис" data-class="Split stretching" data-time="11:30 - 13:00">Записаться на тренировку</button>
