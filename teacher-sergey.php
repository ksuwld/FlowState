...
$static_reviews = [
    ['name' => 'Иголкин Игорь', 'avatar' => 'ava2.png', 'rating' => 4.0, 'text' => 'Сергей — огонь! Тренировка пролетает в бешеном ритме, а на утро колени не болят. Чудо!'],
    ['name' => 'Волкович Владислав', 'avatar' => 'ava2.png', 'rating' => 4.0, 'text' => 'Всю жизнь были проблемы с коленями, но подход Сергея с акцентом на безопасность творит чудеса. Спустя несколько недель колени перестали болеть вовсе. Всем советую!'],
    ['name' => 'Кошкина Яна', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'У меня также были проблемы с коленями, но Сергей помог их полностью устранить. Мало того что у него реально рабочие упражнения, он ещё и объясняет анатомию.'],
    ['name' => 'Даванков Максим', 'avatar' => 'ava9.png', 'rating' => 4.0, 'text' => 'Я хожу ради удовольствия, мне все очень нравится! Сергей невероятно добрый, умеет хорошо располагать к себе людей и ему прям хочется доверять. Сергей вы супер!'],
    ['name' => 'Суворов Евгений', 'avatar' => 'ava8.png', 'rating' => 3.0, 'text' => 'Я думал что такие тренировки больше подходят для женщин, но я сильно ошибался. Нагрузка почти такая же как в зале, но только здесь за тобой следит профессионал. Невероятно классные методики, упражнения и тренировки в целом. Всем советую Сергея!'],
    ['name' => 'Кутузова Алина', 'avatar' => 'ava10.png', 'rating' => 5.0, 'text' => 'Я хожу ради удовольствия также как и Максим, мне все безумно нравится! Сергей никогда не опаздывает, запоминает мою анатомию и подстраивает тренировки под меня.'],
    ['name' => 'Копорина Ксения', 'avatar' => 'ava11.png', 'rating' => 4.0, 'text' => 'Очень профессиональный тренер, который уделяет внимание каждому клиенту. Всё круто!'],
    ['name' => 'Понамарюк Виктор', 'avatar' => 'ava12.png', 'rating' => 3.0, 'text' => 'Очень крутой формат. Потеешь как на пробежке, но мышцы работают как в пилатесе.'],
    ['name' => 'Тушковин Сергей', 'avatar' => 'ava13.png', 'rating' => 5.0, 'text' => 'Похудел на 3 кг за месяц индивидуальных занятий. Сергей отлично держит темп и не дает расслабиться.']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Сидоров Сергей' LIMIT 1");
    $stmt_id->execute();
    $t_row = $stmt_id->fetch(PDO::FETCH_ASSOC);
    $teacher_id = $t_row ? $t_row['id'] : 5; 
...
<head>
    ...
    <title>Сидоров Сергей — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/сергей.png" alt="Сергей Фото 1" class="tp-hero-img">
                <img src="img/сергей1.png" alt="Сергей Фото 2" class="tp-hero-img"> 
                <img src="img/сергей2.png" alt="Сергей Фото 3" class="tp-hero-img">
                <img src="img/сергей3.png" alt="Сергей Фото 4" class="tp-hero-img">
                <img src="img/сергей4.png" alt="Сергей Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        <div class="tp-badge">Стаж: 6 лет</div>
        <h1 class="tp-name">Сидоров Сергей</h1>
        <p class="tp-subtitle">Преподаватель по "Pilates Cardio" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Здравствуйте! Я Сергей, и я знаю, как сжечь максимум калорий, не убивая при этом суставы.</p>
            <p>Pilates Cardio — это мой авторский микс классических принципов пилатеса и интервальной нагрузки. Мы держим высокий пульс за счет интенсивного темпа, но избегаем ударных прыжков. Идеальный вариант для тех, кто хочет похудеть, но бережет свои колени и поясницу.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Интервальный темп:</strong> Чередуем блоки интенсивной работы и активного восстановления для запуска жиросжигания.</li>
                <li><strong>Работа с центром:</strong> Любое кардио-движение мы выполняем с жестко зафиксированным кором (центром Пилатеса).</li>
                <li><strong>Заминка:</strong> Обязательный блок на восстановление дыхания и вытяжение уставших мышц.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Кардио не должно быть разрушительным! Я докажу вам, что можно получить мокрую футболку и эндорфиновый взрыв, оставаясь в зоне безопасности для ваших суставов. Тренируем сердце и строим красивый рельеф одновременно!»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Сидоров Сергей" data-class="Pilates Cardio" data-time="18:00 - 19:30">Записаться на тренировку</button>
