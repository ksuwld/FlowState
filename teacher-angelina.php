...
$static_reviews = [
    ['name' => 'Гуманникова Ирина', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Ангелина перевернула мое представление о пилатесе. Тело заработало по-новому, ушли боли в коленях.'],
    ['name' => 'Погрешкина Ольга', 'avatar' => 'ava4.png', 'rating' => 3.0, 'text' => 'Очень необычные и красивые тренировки. Чувствуешь каждую мышцу в объеме.'],
    ['name' => 'Каторожкина Марина', 'avatar' => 'ava6.png', 'rating' => 5.0, 'text' => 'Тренер с глубочайшими знаниями анатомии. После 3D пилатеса походка стала летящей!'],
    ['name' => 'Давыдина Светлана', 'avatar' => 'ava7.png', 'rating' => 4.0, 'text' => 'Занятия превосходные, впервые вижу такую технику, и она сразу мне очень понравилась!'],
    ['name' => 'Сергеева Екатерина', 'avatar' => 'ava5.png', 'rating' => 4.0, 'text' => 'Замечательный тренер! Каждое занятие продумано до мелочей, очень внимательное отношение к ученикам.'],
    ['name' => 'Васильев Владислав', 'avatar' => 'ava8.png', 'rating' => 4.0, 'text' => 'Мои тренировки всегда проходят просто отлично! Занятия интересные и разнообразные. Спасибо вам, Ангелина!']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Василькова Ангелина' LIMIT 1");
    $stmt_id->execute();
    $t_row = $stmt_id->fetch(PDO::FETCH_ASSOC);
    $teacher_id = $t_row ? $t_row['id'] : 1; 
...
<head>
    ...
    <title>Василькова Ангелина — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/ангелина1.png" alt="Ангелина Фото 1" class="tp-hero-img">
                <img src="img/ангелина2.png" alt="Ангелина Фото 2" class="tp-hero-img"> 
                <img src="img/ангелина3.png" alt="Ангелина Фото 3" class="tp-hero-img">
                <img src="img/ангелина4.png" alt="Ангелина Фото 4" class="tp-hero-img">
                <img src="img/ангелина5.png" alt="Ангелина Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Василькова Ангелина</h1>
        <p class="tp-subtitle">Преподаватель по "3D Pilates" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Рада приветствовать! Я Василькова Ангелина. Я преподаю 3D Pilates — современный подход, основанный на знаниях о фасциальных линиях тела.</p>
            <p>В жизни мы двигаемся в трех плоскостях одновременно, но классический фитнес часто ограничивает нас движениями вперед-назад. Я учу тело работать в объеме: со скручиваниями, боковыми наклонами и ротациями. Это умный фитнес будущего.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Многоплоскостное тестирование:</strong> Проверяем, в какой из плоскостей (сагиттальной, фронтальной или горизонтальной) у вас есть дефицит движения.</li>
                <li><strong>Интеграция движений:</strong> Выполняем плавные, похожие на танец связки пилатеса, которые задействуют все мышечные диагонали.</li>
                <li><strong>Стопа как фундамент:</strong> Особое внимание уделяем биомеханике стопы, так как от нее зависит положение всего позвоночника.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Вы не плоские, вы — объемные! Моя цель — научить ваше тело двигаться функционально, свободно и красиво в любом направлении. 3D Пилатес вернет вам природную грацию хищника.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Василькова Ангелина" data-class="3D Pilates" data-time="16:00 - 17:30">Записаться на тренировку</button>
