...
$static_reviews = [
    ['name' => 'Турчина Вера', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Инь-йога с Марией — мой легальный антидепрессант. Сплю после занятий как младенец.'],
    ['name' => 'Майков Дмитрий', 'avatar' => 'ava2.png', 'rating' => 5.0, 'text' => 'Был скептиком, но эта "медленная" йога восстановила мои суставы после кроссфита. Спасибо!'],
    ['name' => 'Щербатюк Станислав', 'avatar' => 'ava3.png', 'rating' => 5.0, 'text' => 'Маша создает такую атмосферу доверия, что в шавасане можно расплакаться от облегчения. Очень мощная практика.'],
    ['name' => 'Масляков Евгений', 'avatar' => 'ava9.png', 'rating' => 5.0, 'text' => 'Невероятные тренировки! Мария, вы мой фаворит!'],
    ['name' => 'Евкушенко Стася', 'avatar' => 'ava5.png', 'rating' => 5.0, 'text' => 'После пары недель тренировок с Машей мой сон восстановился и я чувствую себя в разы лучше! Спасибо Маш, я в тебя влюблена!'],
    ['name' => 'Леонов Константин', 'avatar' => 'ava8.png', 'rating' => 5.0, 'text' => 'Мария просто волшебница, которая подарила мне возможность хорошо высыпаться!'],
    ['name' => 'Суровина Татьяна', 'avatar' => 'ava7.png', 'rating' => 5.0, 'text' => 'Мария, вы просто профессионал своего дела! Вы прекрасный тренер, собеседник и человек.']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Лапина Мария' LIMIT 1");
    $stmt_id->execute();
    $t_row = $stmt_id->fetch(PDO::FETCH_ASSOC);
    $teacher_id = $t_row ? $t_row['id'] : 2; 
...
<head>
    ...
    <title>Лапина Мария — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/мария4.png" alt="Мария Фото 1" class="tp-hero-img">
                <img src="img/мария.png" alt="Мария Фото 2" class="tp-hero-img"> 
                <img src="img/мария1.png" alt="Мария Фото 3" class="tp-hero-img">
                <img src="img/мария2.png" alt="Мария Фото 4" class="tp-hero-img">
                <img src="img/мария3.png" alt="Мария Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        <div class="tp-badge">Стаж: 11 лет</div>
        <h1 class="tp-name">Лапина Мария</h1>
        <p class="tp-subtitle">Преподаватель по "Yin Yoga" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Меня зовут Мария, и я ваш проводник в мир Инь-йоги. В нашем сумасшедшем ритме жизни, где всё направлено на достижения (Ян), нам критически не хватает замедления (Инь).</p>
            <p>Моя практика — это глубокая терапия для уставшей психики и зажатого тела. Мы работаем не с мышцами, а с соединительными тканями, суставами и связками, оставаясь в асанах по несколько минут.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Погружение:</strong> Настраиваемся на практику через медитацию и технику сканирования тела.</li>
                <li><strong>Длительная фиксация:</strong> Используем болстеры, пледы и блоки, чтобы вы могли находиться в позе от 3 до 5 минут абсолютно комфортно.</li>
                <li><strong>Работа с вниманием:</strong> Я помогаю вам не сбегать от эмоций, которые часто поднимаются во время глубокого раскрытия таза или грудного отдела.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Ваша главная задача на моем занятии — ничего не достигать. Позвольте гравитации сделать всё за вас. Мы будем учиться искусству "не-делания", восстанавливая ресурс и обретая звенящую тишину внутри.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Лапина Мария" data-class="Yin Yoga" data-time="9:30 - 11:00">Записаться на тренировку</button>
