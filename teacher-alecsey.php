...
$static_reviews = [
    ['name' => 'Погрешкина Ольга', 'avatar' => 'ava4.png', 'rating' => 5.0, 'text' => 'Очень необычные и красивые тренировки. Чувствуешь каждую мышцу в объеме.'],
    ['name' => 'Каторожкина Марина', 'avatar' => 'ava6.png', 'rating' => 5.0, 'text' => 'Хорошие тренировки плохие тренера не преподают. Алексей, вы супер!'],
    ['name' => 'Давыдина Светлана', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Идеальный баланс между силой и растяжкой. Тело стало рельефным и очень подтянутым.'],
    ['name' => 'Сергеева Екатерина', 'avatar' => 'ava7.png', 'rating' => 5.0, 'text' => 'Впервые встала на стойку на голове. Алексей вселяет невероятную уверенность в свои силы.'],
    ['name' => 'Васильев Владислав', 'avatar' => 'ava8.png', 'rating' => 5.0, 'text' => 'Думал, йога для слабаков. Алексей ушатал меня за 20 минут! Крутейшая силовая нагрузка.']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Журавлёв Алексей' LIMIT 1");
    $stmt_id->execute();
...
<head>
    ...
    <title>Журавлёв Алексей — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/алексей.png" alt="Алексей Фото 1" class="tp-hero-img">
                <img src="img/алексей1.png" alt="Алексей Фото 2" class="tp-hero-img"> 
                <img src="img/алексей2.png" alt="Алексей Фото 3" class="tp-hero-img">
                <img src="img/алексей3.png" alt="Алексей Фото 4" class="tp-hero-img">
                <img src="img/алексей4.png" alt="Алексей Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Журавлёв Алексей</h1>
        <p class="tp-subtitle">Преподаватель по "Power Yoga" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Привет! Я Алексей Журавлёв. Кто сказал, что йога — это только про сидение в лотосе?</p>
            <p>Power Yoga (Силовая йога) — это вызов гравитации, динамика и пот. Мой стиль сочетает в себе философию аштанга-виньясы и современный силовой тренинг. Я учу строить мышечный рельеф и железную выносливость исключительно за счет веса собственного тела.</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Интенсивные виньясы:</strong> Непрерывный поток движений, синхронизированных с дыханием, разгоняющий метаболизм.</li>
                <li><strong>Балансы на руках:</strong> Мы безопасно учимся стоять на руках, предплечьях и выполнять Бакасану (позу ворона).</li>
                <li><strong>Силовая статика:</strong> Удержание сложных асан для развития глубокой мышечной силы и ментальной стойкости.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Ваша сила уже внутри вас, я лишь помогу её разбудить. Power Yoga покажет, что ваше тело способно на невероятные вещи. Мы будем потеть, преодолевать себя, но делать это бережно и с улыбкой.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Журавлёв Алексей" data-class="Power Yoga" data-time="18:00 - 19:30">Записаться на тренировку</button>
    ...
    <div class="tp-modal-overlay" id="success-modal" style="display: none;">
        <div class="tp-modal-content">
            ...
            <p class="tp-modal-text">Ждем вас на тренировке. Вы будете перенаправлены в личный кабинет через <strong id="countdown-timer">3</strong> сек...</p>
        </div>
    </div>
