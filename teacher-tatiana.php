...
$static_reviews = [
    ['name' => 'Гуманникова Ирина', 'avatar' => 'ava1.png', 'rating' => 5.0, 'text' => 'Ушли жуткие боли между лопатками. Таня — мастер по раскрытию грудного отдела.'],
    ['name' => 'Тиньков Олег', 'avatar' => 'ava2.png', 'rating' => 3.0, 'text' => 'После тренировок с Татьяной я наконец-то перестал сутулиться за ноутбуком. Очень рабочие техники!'],
    ['name' => 'Разнобравин Давид', 'avatar' => 'ava3.png', 'rating' => 5.0, 'text' => 'Очень вдумчивый и профессиональный подход к делу. Спасибо за отличные тренировки!']
];

try {
    $stmt_id = $pdo->prepare("SELECT id FROM teachers WHERE full_name = 'Капорина Татьяна' LIMIT 1");
    $stmt_id->execute();
...
<head>
    ...
    <title>Капорина Татьяна — FlowState</title>
...
<body class="teacher-profile-page">
    ...
    <section class="tp-hero">
        ...
        <div class="tp-slider-container" id="hero-slider">
            <div class="tp-slider-track" id="hero-track">
                <img src="img/татьна.png" alt="Татьяна Фото 1" class="tp-hero-img">
                <img src="img/татьяна1.png" alt="Татьяна Фото 2" class="tp-hero-img"> 
                <img src="img/татьяна2.png" alt="Татьяна Фото 3" class="tp-hero-img">
                <img src="img/татьяна3.png" alt="Татьяна Фото 4" class="tp-hero-img">
                <img src="img/татьяна4.png" alt="Татьяна Фото 5" class="tp-hero-img">
            </div>
        </div>
    ...
    <section class="tp-header-info">
        ...
        <h1 class="tp-name">Капорина Татьяна</h1>
        <p class="tp-subtitle">Преподаватель по "Posture Stretch" / Персональный тренер</p>
        <div class="tp-rating">
    ...
    <section class="tp-bio-section">
        <div class="tp-bio-card">
            <p>Привет! Я Таня, ваш личный архитектор осанки. В эпоху смартфонов наша главная проблема — "текстовая шея" и закрытая грудная клетка.</p>
            <p>Моя программа Posture Stretch направлена на раскрытие плеч, снятие напряжения с шейно-воротниковой зоны и укрепление мышц между лопатками. Я сделаю всё, чтобы ваш взгляд был устремлен вперед, а спина была прямой без усилий!</p>
            
            <p><strong>Как проходят наши индивидуальные занятия:</strong></p>
            <ul>
                <li><strong>Тест мобильности плеч:</strong> Проверяем амплитуду движения в плечевых суставах и грудном отделе.</li>
                <li><strong>Релиз грудных мышц:</strong> Снимаем спазм с мышц груди, которые "тянут" плечи вперед.</li>
                <li><strong>Укрепление спины:</strong> Точечно закачиваем ромбовидные и трапециевидные мышцы, которые будут держать плечи раскрытыми.</li>
            </ul>

            <p><strong>Мой манифест:</strong></p>
            <p>«Ваша осанка транслирует миру вашу уверенность. Хватит прятать свое сердце! Мы раскроем грудную клетку, снимем груз с ваших плеч, и вы начнете дышать полной грудью, чувствуя себя на 10 сантиметров выше.»</p>
        </div>
    </section>
    ...
    <section class="tp-booking-section">
        <button class="tp-btn-book" id="book-btn" data-teacher="Капорина Татьяна" data-class="Posture Stretch" data-time="20:30 - 22:00">Записаться на тренировку</button>
